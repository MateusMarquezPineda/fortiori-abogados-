                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-column">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="/la-empresa-y-el-empresario/" class="footer-link">La Empresa y el Empresario</a></li>
                            <li><a href="/derecho-laboral-y-seguridad-social/" class="footer-link">Derecho Laboral y Seguridad Social</a></li>
                        ...
                        <ul class="footer-contact">
                            <li class="footer-contact-item">
                                ...
                                <div>
                                    ...
                                    Carrera 6 # 10-42 Oficina 512<br>
                                    Bogotá, Colombia
                                </div>
                            </li>
                            <li class="footer-contact-item">
            ...
            <div class="container">
                <div class="footer-bottom-content">
                    <p class="footer-copyright">
                        &copy; <?= date('Y') ?> FORTIORI ABOGADOS S.A.S. - NIT 901.013.525-1. Todos los derechos reservados.
                    </p>
